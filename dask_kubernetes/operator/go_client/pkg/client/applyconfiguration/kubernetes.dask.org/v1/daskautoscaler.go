...
// DaskAutoscalerApplyConfiguration represents an declarative configuration of the DaskAutoscaler type for use
// with apply.
...
// DaskAutoscaler constructs an declarative configuration of the DaskAutoscaler type for use with
// apply.
func DaskAutoscaler(name, namespace string) *DaskAutoscalerApplyConfiguration {
	b := &DaskAutoscalerApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("DaskAutoscaler")
...
func (b *DaskAutoscalerApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {

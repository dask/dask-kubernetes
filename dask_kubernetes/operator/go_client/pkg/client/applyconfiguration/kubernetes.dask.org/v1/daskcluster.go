...
// DaskClusterApplyConfiguration represents an declarative configuration of the DaskCluster type for use
// with apply.
...
// DaskCluster constructs an declarative configuration of the DaskCluster type for use with
// apply.
func DaskCluster(name, namespace string) *DaskClusterApplyConfiguration {
	b := &DaskClusterApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("DaskCluster")
...
func (b *DaskClusterApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
